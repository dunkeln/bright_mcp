...
The profile is separate because it has distinct state, cost, open-world mutation,
and a four-tool contract. It shares the caller's API-key identity with the data
profiles, has no data tools, and has no required MCP app.
